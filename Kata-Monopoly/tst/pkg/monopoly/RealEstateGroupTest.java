...
public class RealEstateGroupTest {
    ...
    public void testLandOnUnownedPropertyWithEnoughMoney() {
        ...
        mediterraneanAve.landOn(player1, "Roll", new SourceOfMoveMultiplier(), new OwnershipMultiplier());
        assertEquals(player1, mediterraneanAve.getOwner());
    ...
    public void testLandOnOwnedAndUnMortgagedPropertyNoHousesOrHotel() {
        ...
        balticAve.landOn(player1, "Roll", new SourceOfMoveMultiplier(), new OwnershipMultiplier());
        checkPlayersCashBalances(player1EndingBalance, player2EndingBalance);

        balticAve.landOn(player2, "Roll", new SourceOfMoveMultiplier(), new OwnershipMultiplier());
        checkPlayersCashBalances(player1EndingBalance, player2EndingBalance);
    }
    ...
    public void testPlayerDoesNotPayHimselfRent() {
        ...
        mediterraneanAve.landOn(playerMock, "Roll", new SourceOfMoveMultiplier(), new OwnershipMultiplier());
